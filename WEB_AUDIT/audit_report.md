...
|---|---|---|---|
| A | file exists: index.html | PASS | /mnt/data/ThermoBase_v20/index.html |
| A | file exists: app.js | PASS | /mnt/data/ThermoBase_v20/app.js |
| A | file exists: styles.css | PASS | /mnt/data/ThermoBase_v20/styles.css |
| A | file exists: data/thermobase.json | PASS | /mnt/data/ThermoBase_v20/data/thermobase.json |
...
| C | HTML IDs unique | PASS | 152 IDs |
...
| G | 14/14 has non-probabilistic framing | PASS | mentions=5, explicit_negation=True |
